...
import { getFormatService, getQueryService, getOpenSearchDashboardsLegacy } from './maps_explorer_dashboards_services';
import {
  geoContains,
  mapTooltipProvider,
  lazyLoadMapsExplorerDashboardsModules,
} from '.';
...
export const createVisualization = (dependencies) => {
  ...
  return class CoordinateMapsVisualization extends BaseMapsVisualization {
    ...
    async _recreateGeohashLayer() {
      const { GeohashLayer } = await import('./map/layer/geohash_layer/geohash_layer');
